Blockly.circuitpython['dict_constructor'] = function(block) {
    const code = `dict()`;
    return [code, 0];
};

Blockly.circuitpython['dict_brackets'] = function(block) {
...
Blockly.circuitpython['dict_brackets_equals'] = function(block) {
    const dict_name = Blockly.Python.nameDB_.getName(block.getFieldValue('dict_name'), Blockly.VARIABLE_CATEGORY_NAME);
